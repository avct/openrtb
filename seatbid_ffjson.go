...
handle_Bid:
	...
	/* handler: uj.Bid type=[]openrtb.Bid kind=slice */

	{
		/* Falling back. type=[]openrtb.Bid kind=slice */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}

		err = json.Unmarshal(tbuf, &uj.Bid)
		if err != nil {
			return fs.WrapErr(err)
		}
	}
...
handle_Seat:
	...
	/* handler: uj.Seat type=string kind=string */
...
handle_Group:
	...
	/* handler: uj.Group type=int kind=int */
