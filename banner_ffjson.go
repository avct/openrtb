...
handle_Wmax:
	...
	/* handler: uj.Wmax type=int kind=int */
...
handle_Hmax:
	...
	/* handler: uj.Hmax type=int kind=int */
...
handle_Wmin:
	...
	/* handler: uj.Wmin type=int kind=int */
...
handle_Hmin:
	...
	/* handler: uj.Hmin type=int kind=int */
...
handle_Btype:
	...
	/* handler: uj.Btype type=[]int kind=slice */
...
handle_Topframe:
	...
	/* handler: uj.Topframe type=int kind=int */
...
handle_Expdir:
	...
	/* handler: uj.Expdir type=[]int kind=slice */
