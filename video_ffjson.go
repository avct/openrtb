...
handle_Mimes:
	...
	/* handler: uj.Mimes type=[]string kind=slice */
...
handle_Minduration:
	...
	/* handler: uj.Minduration type=int kind=int */
...
handle_Maxduration:
	...
	/* handler: uj.Maxduration type=int kind=int */
...
handle_Protocol:
	...
	/* handler: uj.Protocol type=interface {} kind=interface */

	{
		...
		err = json.Unmarshal(tbuf, &uj.Protocol)
		if err != nil {
			return fs.WrapErr(err)
		}
	}
...
handle_Protocols:
	...
	/* handler: uj.Protocols type=[]int kind=slice */
...
handle_W:
	...
	/* handler: uj.W type=int kind=int */
...
handle_H:
	...
	/* handler: uj.H type=int kind=int */
...
handle_Startdelay:
	...
	/* handler: uj.Startdelay type=int kind=int */
...
handle_Linearity:
	...
	/* handler: uj.Linearity type=int kind=int */
...
handle_Sequence:
	...
	/* handler: uj.Sequence type=int kind=int */
...
handle_Battr:
	...
	/* handler: uj.Battr type=[]int kind=slice */
...
handle_Maxextended:
	...
	/* handler: uj.Maxextended type=int kind=int */
...
handle_Minbitrate:
	...
	/* handler: uj.Minbitrate type=int kind=int */
...
handle_Maxbitrate:
	...
	/* handler: uj.Maxbitrate type=int kind=int */
...
handle_Boxingallowed:
	...
	/* handler: uj.Boxingallowed type=int kind=int */
...
handle_Playbackmethod:
	...
	/* handler: uj.Playbackmethod type=[]int kind=slice */
...
handle_Delivery:
	...
	/* handler: uj.Delivery type=[]int kind=slice */
...
handle_Pos:
	...
	/* handler: uj.Pos type=int kind=int */
...
handle_Companionad:
	...
	/* handler: uj.Companionad type=[]openrtb.Banner kind=slice */

	{
		/* Falling back. type=[]openrtb.Banner kind=slice */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}

		err = json.Unmarshal(tbuf, &uj.Companionad)
		if err != nil {
			return fs.WrapErr(err)
		}
	}
...
handle_Api:
	...
	/* handler: uj.Api type=[]int kind=slice */
...
handle_Companiontype:
	...
	/* handler: uj.Companiontype type=[]int kind=slice */
