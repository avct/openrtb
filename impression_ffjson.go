...
handle_Banner:
	...
	/* handler: uj.Banner type=openrtb.Banner kind=struct */
...
handle_Displaymanager:
	...
	/* handler: uj.Displaymanager type=string kind=string */

	{
		...
		if tok == fflib.FFTok_null {
			...
			uj.Displaymanager = nil

		} else {

			var tval string
			tval = string(fs.Output.String())
			uj.Displaymanager = &tval
...
handle_Displaymanagerver:
	...
	/* handler: uj.Displaymanagerver type=string kind=string */

	{
		...
		if tok == fflib.FFTok_null {
			...
			uj.Displaymanagerver = nil

		} else {

			var tval string
			tval = string(fs.Output.String())
			uj.Displaymanagerver = &tval
...
handle_Instl:
	...
	/* handler: uj.Instl type=int kind=int */
...
handle_Tagid:
	...
	/* handler: uj.Tagid type=string kind=string */
...
handle_Secure:
	...
	/* handler: uj.Secure type=int kind=int */
...
handle_Iframebuster:
	...
	/* handler: uj.Iframebuster type=[]string kind=slice */
