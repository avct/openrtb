...
handle_Ver:
	...
	/* handler: uj.Ver type=string kind=string */
...
handle_Bundle:
	...
	/* handler: uj.Bundle type=string kind=string */
...
handle_Paid:
	...
	/* handler: uj.Paid type=int kind=int */
...
handle_Storeurl:
	...
	/* handler: uj.Storeurl type=string kind=string */
